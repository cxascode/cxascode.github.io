...
const ABOUT_CX_AS_CODE_TEXT = (
  <>
    ...
    attribute change history, a suggested resource creation order by dependency tier, the{" "}
    <strong>Export builder</strong> for multi-type export workflows, and{" "}
    <strong>Stagehand</strong> for Genesys Cloud admin tools. Site updates track Explorer
