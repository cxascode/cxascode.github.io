# this is a simple test of genesys cloud permissions
...
resource "genesyscloud_routing_wrapupcode" "hello_world" {
  name        = "Hello World"
  division_id = data.genesyscloud_auth_division.adam_test.id
}